...
\vspace{0.25in}
\noindent{\sffamily\fontsize{58}{58}\selectfont{}\hspace*{-4pt}\color{DDarkBlue}{\color{DarkGray}Mathematical}Logic}

\vspace{0.15in}
\noindent{\sffamily\fontsize{21.5}{21.5}\selectfont{}\color{DDDarkBlue}{Richard Grandy} \color{DarkGray}{$\bullet$} \color{DDDarkBlue}{Michael Barkasi} \color{DarkGray}{$\bullet$} \color{DDDarkBlue}{Joshua Reagan}}
