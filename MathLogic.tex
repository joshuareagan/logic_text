...
\vspace{0.15in}
\noindent{\sffamily\fontsize{22}{22}\selectfont{}\color{DDDarkBlue}{Richard Grandy} \color{DarkGray}{$\cdot$} \color{DDDarkBlue}{Michael Barkasi} \color{DarkGray}{$\cdot$} \color{DDDarkBlue}{Joshua Reagan}}
