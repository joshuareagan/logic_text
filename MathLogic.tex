...
\vspace{0.15in}
\noindent{\sffamily\fontsize{21.5}{21.5}\selectfont{}\color{DDarkGray}{Richard Grandy} \color{DDarkBlue}{$\bullet$} \color{DDarkGray}{Michael Barkasi} \color{DDarkBlue}{$\bullet$} \color{DDarkGray}{Joshua Reagan}}
