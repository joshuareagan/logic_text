...
For any sequence of derivation lines that is a derivation (see definition \pmvref{Recursive definition of Derivation}), the sentence $\CAPPHI$ on the last line is entailed by the set $\Delta$ of sentences that are on unboxed lines and are sanctioned by \Rule{Assume}. 
\end{THEOREM}
