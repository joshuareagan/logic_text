...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The Basic System \GQD{}}\label{Section GQD}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Shortcut Rules for \GQD{}}

Like \GSD{}, we extend \GQD{} by adding shortcut rules. 
First, we include all the shortcut rules we gave for \GSD{}, both the standard and exchange rules. 
Second, we include shortcut rules specifically for the quantifiers (see table \ref{GQDplus}).
These new \emph{quantifier negation} rules are found in table \ref{GQDplus}.
