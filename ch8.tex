...
Our strategy is to first prove the completeness of \GQD{} and then show how to modify the method to prove the strong completeness.
Our strategy for proving completeness is to show that for any sentence we can either (1) find a derivation of it or (2) prove that there is a model that makes it false. 
...
Put more positively, if the method produces a sentence in standardized form which has only existential, or only universal quantifiers, then the method stops. 
...
But, we are done then since no more new constants are added. 
